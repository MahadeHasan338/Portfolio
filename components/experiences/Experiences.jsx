...
const Experiences = () => {
  const experienceData = [
    {
      ...
      desc: ["Description of responsibilities and achievements..."],
      duration: "January 2020 - Present",
    },
    {
      company: "XYZ Web Development",
      position: "Web Developer Intern",
      desc: ["Description of internship responsibilities..."],
  ...
  const educationData = [
    {
      institute: "University ABC",
      degree: "Bachelor of Science in Computer Science",
      desc: ["Relevant coursework and achievements..."],
      duration: "August 2016 - May 2020",
    },
    {
      institute: "High School XYZ",
      degree: "High School Diploma",
      desc: ["Achievements and extracurricular activities..."],
